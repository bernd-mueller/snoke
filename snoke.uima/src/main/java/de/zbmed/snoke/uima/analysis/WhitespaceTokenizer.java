...
/**
 * Custom analysis engine WhitespaceTokenizer creating tokens separated by
 * whitespaces in text.
 *
...
public class WhitespaceTokenizer extends CasAnnotator_ImplBase {
   ...
   public static final String TOKEN_ANNOTATION_NAME = "org.apache.uima.conceptMapper.support.tokenizer.TokenAnnotation";

   public static final String SENTENCE_ANNOTATION_NAME = "org.apache.uima.SentenceAnnotation";

   public static final String TOKEN_TYPE_FEATURE_NAME = "type";
   ...
   public static final String MESSAGE_BUNDLE = "de.zbmed.tdm.uima.analysis.whitespaceTokenizerMessages";
...
//         System.out.println("###CAS " + cas.getViewName());
