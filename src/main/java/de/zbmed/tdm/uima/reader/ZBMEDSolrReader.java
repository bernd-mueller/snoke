package de.zbmed.tdm.uima.reader;
 ...
 * @since 2016
 */
public class ZBMEDSolrReader extends CollectionReader_ImplBase {
...
//				}
	...
	public int getDocCursor() {
		return docCursor;
	}

	public void setDocCursor(int docCursor) {
